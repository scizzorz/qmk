...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_CAPS, KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,  \
  KC_CAPS, _______, KC_LGUI, KC_LALT, NUM,     FN,      KC_LCTL, KC_SPC,  KC_RALT, KC_RGUI, _______, KC_RCTL  \
),

[_NUM] = LAYOUT_preonic_grid( \
  KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    _______, KC_LPRN, KC_RPRN, _______, _______, _______, KC_BSLS,
  _______, KC_5,    KC_6,    KC_7,    KC_8,    _______, KC_LBRC, KC_RBRC, _______, _______, _______, _______,
